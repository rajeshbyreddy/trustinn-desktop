...
function buildItems(pool, seg) {
  ...
  let normalizedImages = normalizeImagePool(pool);

  if (normalizedImages.length === 0) {
    normalizedImages = normalizeImagePool(DEFAULT_IMAGES);
    console.warn('[DomeGallery] No valid image entries found. Falling back to DEFAULT_IMAGES.');
  }
...
export default function DomeGallery({
  ...
  const fallbackImageSrc = DEFAULT_IMAGES[0]?.src || '';
          ...
          <div ref={sphereRef} className="sphere">
            {items.map((it, i) => (
              ...
              >
                ...
                >
                  <img src={it.src || fallbackImageSrc} draggable={false} alt={it.alt} />
                </div>
              </div>
            ))}
          </div>
